...
\hlkwd{install.packages}\hldef{(}\hlkwd{c}\hldef{(}\hlsng{"dplyr"}\hldef{,} \hlsng{"tidytext"}\hldef{,} \hlsng{"topicmodels"}\hldef{,} \hlsng{"tm"}\hldef{,} \hlsng{"zoo"}\hldef{))}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hldef{pap} \hlkwb{<-} \hlkwd{anti_join}\hldef{(pap,} \hlkwc{y} \hldef{= stopwords[stopwords}\hlopt{$}\hldef{lexicon} \hlopt{==} \hlsng{"snowball"}\hldef{,])}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hldef{)}
\hldef{pap} \hlkwb{<-} \hlkwd{anti_join}\hldef{(pap,} \hlkwc{y} \hldef{= rare_words)}
\end{alltt}
\end{kframe}
\end{knitrout}
